  ...
  const photo = [
    {
      id: 10,
      title: "Spa",
      description: "Indulge in relaxation and pampering with our spa services. Let us help you look and feel your best on your special day.",
      icon: <SpaIcon color="var(--button-color)"/>
    },
    {
      id: 11,
      title: "Photographers & Videographers",
      description: "Capture the magic of your wedding day with our expert photographers and videographers. We'll make sure every moment is beautifully preserved.",
      ...
      <div className="common-name">
        ...
        {photo.map((service) => (
          <div key={service.id}>
            ...
            >
              <p>{service.title} {service.icon}</p>
